...
%token T_CLASS T_PUBLIC T_PRIVATE T_PROTECTED T_ARRAY T_BOOL T_CHR
%left T_ADD T_SUB
%left T_MUL T_DIV
...
|T_STR { printf("ok");strcpy(tdType,$1);}
|T_DOUBLE {strcpy(tdType,$1);}
|T_VOID {strcpy(tdType,$1);}
|T_BOOL {strcpy(tdType,$1);}
;
...
BOOL: T_TRUE {$$ = "1"; push($1); strcpy(val,$$);}
| T_FALSE {$$ = "0"; push($1); strcpy(val,$$);}
;
